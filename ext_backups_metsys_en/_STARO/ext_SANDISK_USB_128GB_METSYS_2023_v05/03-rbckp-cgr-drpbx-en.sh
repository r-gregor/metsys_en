...
### (tms; echo "Backing up /c/Users/gregor.redelonghi/majstaf_en/drpbx-en/{ODPRTO,SKUPNI} to ${gr_DRIVE} ...") | tee -a ${gr_LOGF}
### 
### (tms; echo "Syncing /c/Users/gregor.redelonghi/majstaf_en/drpbx-en/ODPRTO ...") | tee -a ${gr_LOGF}
...
### 
### (tms; echo "Syncing /c/Users/gregor.redelonghi/majstaf_en/drpbx-en/SKUPNI ...") | tee -a ${gr_LOGF}
