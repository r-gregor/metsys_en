...
### Name:	 002_rbckp_cgr_Downloads_en.sh
### Date:	(2017-09-11)
###          20190826
###
### Decription:
...
###
### UPDATE 20201027
### Automatic cd into right directory --> can be run from anywhere!!
...
${gr_RSO} --exclude "Downloaded-ISO-s" /c/Users/gregor.redelonghi/Downloads/ ${gr_BEKAPD}/Downloads_cugr_en/ | eval ${gr_FILT} | while read line; do (tms; echo $line); done
