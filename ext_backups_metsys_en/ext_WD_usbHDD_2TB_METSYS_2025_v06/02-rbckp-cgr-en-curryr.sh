...
# START
(tms; echo "Backing up /c/Users/gregor.redelonghi/${curryr} to ${gr_BEKAPD} ... ")
(tms; echo "Syncing ...  ")
${gr_RSO} --delete /c/Users/gregor.redelonghi/${curryr}/ ${gr_BEKAPD}/CURRYR_cugr_en/ | eval ${gr_FILT} | while read line; do (tms; echo $line); done
(tms; crtc $crtn)
